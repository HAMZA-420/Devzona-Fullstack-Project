...
const transporter = nodemailer.createTransport({service: "Gmail", auth: {user:
config.user.email, pass: config.user.password}});
...
exports.sendMail = functions.https.onRequest((request, response) => {
  cors(request, response,() => {
    ...
    mailOptions = {from: "DevZona", to:"mhk420520620@gmail.com", 
   ...
   `<p style="font-size: 16px>From: ${name}</p>
    ...
    mailOptions = {from: "DevZona", to:email, 
    subject: "We have received your messag!", 
    html: 
