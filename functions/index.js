...
let mailOptions = {
  from: "mhamzakhan.cui@gmail.com",
};
exports.sendMail=functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    const {name, email, phone, message, total, service,
      platforms, features, customFeatures, users, category}=request.query;
    if (total) {
      if (category) {
        mailOptions = {
          from: "DevZona",
          to: "mhk420520@gmail.com",
        ...
        <P style="font-size: 16px">Total: ${total}</p>
        <P style="font-size: 16px">Service: ${service}</p>
        <P style="font-size: 16px">Category: ${platforms}</p>
  ...
  go over details and get back to you as soon as 
  possible.
  </td>
  </tr>
  </table>
