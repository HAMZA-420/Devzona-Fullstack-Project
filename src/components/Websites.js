        ...
        <Grid container direction="column">
            ...
            >
                ...
                <Grid item className={classes.arrowContainer}>
                    ...
                    >
                        <img src={forwardArrow} alt="Forward Services Page" />
                    </IconButton>
                </Grid>
                </Hidden>
            </Grid>
            ...
            >
                ...
                <Grid item className={classes.paragraphContainer}>
                    ...
                    trends in your business, empowering you to make smarter 
            ...
            >
                <Grid item>
                    <Grid container direction="column">
                        <Grid item>
                            <Typography align={matchesSM?"center": undefined} align="center" variant="h4" gutterBottom>Ecommerce</Typography>
                        </Grid>
                        <Grid item>
                            <img 
                            src={ecommerce} 
            ...
            className={classes.rowContainer}>
                ...
                <Grid item style={{marginLeft: matchesSM? 0: "1em"}}  className={classes.paragraphContainer}>
                    <Typography align={matchesSM?"center": undefined}  variant="body1">
                     ...
                     a great way to help customers decide what's right for them before
                     visiting in person.
                    </Typography>
                </Grid>
            </Grid>
            ...
            >
                ...
                <Grid item style={{marginLeft: matchesSM? 0: "1em"}} className={classes.paragraphContainer}>
                    <Typography align={matchesSM? "center": undefined}  variant="body1" paragraph>
                        How often have you ever been in the second page of Google results?
                    </Typography>
                    <Typography align={matchesSM? "center": undefined} variant="body1" paragraph>
