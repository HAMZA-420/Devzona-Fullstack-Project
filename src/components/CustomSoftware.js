        ...
        <Grid container direction="column" >
            ...
            >
                ...
                <Grid item container direction="column" className={classes.heading}>
                    ...
                    <Grid item>
                        ...
                        Devzona is here to help your business tackle technology.
                        </Typography>
                        <Typography align={matchesMD ? "center": undefined} variant="body1" paragraph>
            ...
            >
                ...
                style={{marginBottom: matchesMD ? "15em": 0}} md> 
                    ...
                    <Grid item md>
                        <Lottie isStopped={true} options={documentsOptions} 
                        style={{maxWidth: 275, maxWidth: 275, minHeight: 250}}
                        />
                    </Grid>
                </Grid>
                <Grid item container className={classes.itemContainer}
                ...
                <Grid item md>
                        ...
                        style={{maxWidth: 260, maxWidth: 280}}
                        />
                    </Grid>
            ...
            >
                <Grid item container direction="column" alignItems="center">
                    ...
                    <Grid item className={classes.itemContainer}>
                        ...
                        <Typography variante="body1" align="center" paragraph>
            ...
            >
                ...
                md> 
                    <Grid item container direction="column" md>
                        ...
                        <Grid item>
                            ...
                            <Typography variant="body1" paragraph align={matchesSM ? "center": undefined} >
                            We can help you identify processes wuth time or event based
                            actions which can now easily be automated.
                            </Typography>
                            <Typography variant="body1" paragraph align={matchesSM ? "center": undefined} >
                            Increasing efficiency increses profits, leaving you more time 
                            to focus on your business, not busywork.
                            </Typography>
                        </Grid>
                    </Grid>
                    <Grid item md>
                        <Lottie isStopped={true} options={automationOptions} 
                        style={{maxWidth: 290, maxWidth: 280}}
                        />
                    </Grid>
                </Grid>
                <Grid item container className={classes.itemContainer} 
                ...
                <Grid item md>
                        ...
                        style={{maxWidth: 310, maxWidth: 155}}
                        />
                    </Grid>
                    <Grid item container direction="column" md>
                        <Grid item>
